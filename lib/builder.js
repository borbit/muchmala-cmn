...
Builder.prototype.buildPuzzle = function(op, each, cb) {
  var self = this;
  async.forEachSeries(op.images, function(imagePath, cb) {
    async.waterfall([
      function(cb) {
        self.loadImage(imagePath, cb);
      },
      function(image, cb) {
...
Builder.prototype.processImage = function(image, op, cb) {
  var puzzle = new db.Puzzles(this.redisClient);
