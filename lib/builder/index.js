...
Builder.prototype.processImage = function(image, op, cb) {
  ...
  var map = mapper.map(image.width, image.height, op.pieceSize);
  var dir, image;
...
Builder.prototype.buildFrames = function(op, cb) {
  var dir = path.join(op.dirPath, op.pieceSize+'');
  var self = this;
...
function loadImage(imagePath, cb) {
